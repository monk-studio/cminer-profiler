...
class PlayerPresets(Base):
    ...
    crit_damage_init = Column(Integer)
    crit_damage_growth = Column(Integer)
    crit_prob_init = Column(Integer)
    crit_prob_growth = Column(Integer)
    lucky_prob_init = Column(Integer)
    lucky_prob_growth = Column(Integer)
